...
public:
	...
	*/
	...
	std::map<int, int> getChanSaved() { return chanSaved; }
...
public:
	...
	*/
	...
	std::map<int, int> getSavedChans() { return headerdata->getChanSaved(); }
	...
	void getImageSize(int & h, int & w) { h = m_imageheight; w = m_imagewidth; }
